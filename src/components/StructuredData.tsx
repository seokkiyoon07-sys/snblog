    ...
    switch (type) {
      case 'article':
        return {
          ...
          "publisher": {
            ...
            "logo": {
              "@type": "ImageObject",
              "url": "https://blog.snacademy.co.kr/image/sn-logo.avif"
            }
          },
      ...
      case 'organization':
        return {
          ...
          "logo": "https://blog.snacademy.co.kr/image/sn-logo.avif",
          "sameAs": [
      ...
      default:
        return {
          ...
          "potentialAction": {
            "@type": "SearchAction",
            "target": "https://blog.snacademy.co.kr/search?q={search_term_string}",
