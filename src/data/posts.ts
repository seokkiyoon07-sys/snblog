...
export const allPosts: Post[] = [
  {
    ...
    content: `# SN독학기숙학원 방화벽의 모든 것! (Feat. SNarlink)
...
![SNarlink 로고](/image/SNarlink/SNarlink.png)
...
교육과 AI의 융합으로 학생 개개인의 잠재력을 극대화하는 **초개인화 학습 혁신**을 실현합니다.

![AI 스타트업 소개 이미지](https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&h=400&fit=crop&crop=center)
...
### 🏢 팀 구성
- **대표 (CEO)**: 교육 현장 12년 경험, 전략과 비전을 이끄는 리더
...
- **SN독학기숙학원 임직원**: 양평점 현장 운영 및 학생 관리
...
### 중기 목표 (2026년)
- 대치점 오픈 및 AI 교육 혁신 실현
- 교육 AI 플랫폼 상용화

### 장기 목표 (2027년+)
- 전국 교육 기관 대상 AI 솔루션 제공
- 교육 분야 AI 기술 선도 기업으로 성장
...
**입학 문의**
- SN독학기숙학원: https://www.snacademy.co.kr
- 대치점 오픈 정보: 2026년 1월 예정
...
![SN Originals 고전문학 시리즈의 시작](/image/originalintro1.png)
...
![SN오리지날 고전문학 시리즈 - 북천가 예시](/image/originalintro2.png)
