...
모든 학습자가 자신의 잠재력을 최대한 발휘할 수 있는 교육 환경을 만들어가는 것이 SN Academy의 꿈입니다.

## 📞 문의하기

더 자세한 정보가 필요하시다면 언제든지 연락주세요!`,
    category: 'startup',
    tags: ['AI교육', '스타트업', '에듀테크'],
    author: 'SN Academy',
    date: '2025-09-29',
...
## 📚 보기만 해도 수능 점수가 오르는 국어 고전문학 시리즈

안녕하세요! SN Academy에서 준비한 특별한 고전문학 시리즈를 소개합니다. 이 시리즈는 단순히 시험을 위한 암기가 아닌, **진정한 문학의 아름다움**을 느낄 수 있도록 구성되었습니다.
...
### 1탄: 관동별곡
- **정철의 강원도 브이로그** (고전문학 「관동별곡」)
- 조선시대 관동지방의 아름다운 풍경을 노래한 가사

### 2탄: 북천가
- **좋긴 한데 유배 생활 이래도 됨?** 고전문학 「북천가」
- 유배지에서의 복잡한 감정을 담은 작품

### 3탄: 화왕가
- **너 그렇게 여자만 좋아하다 피똥싼다** (수능 고전문학 「화왕가」)
- 사회비판적 메시지가 담긴 가사

### 4탄: 갑민가
- **내 속도 모르면서 가라 마라 막말하지 마라** (수능 고전문학 「갑민가」)
- 민중의 목소리를 담은 작품

### 5탄: 사미인곡
- **선조를 향한 정철의 중독된 사랑** (고전문학 「사미인곡」)
- 정치적 충성과 개인적 감정의 교차
...
- **수능 국어 점수 향상**: 체계적인 분석으로 문제 해결 능력 증진
- **문학적 감성 함양**: 단순 암기를 넘어선 진정한 이해
- **글로벌 시각 확장**: 한국 문학의 세계적 가치 인식

## 🎬 YouTube 연계 학습

각 작품마다 전용 YouTube 영상과 연계하여:
- 시각적 학습 효과 극대화
- 이해도 향상 및 기억력 증진
- 언제든지 반복 학습 가능
...
더 자세한 학습 방법이나 궁금한 점이 있으시면 언제든지 연락주세요!`,
    category: 'originals',
