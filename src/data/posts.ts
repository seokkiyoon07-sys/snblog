...
export const allPosts: Post[] = [
  {
    ...
    excerpt:
      '대치동에 AI 특화 독학관리학원 "고요의 숲"을 런칭합니다. 수능을 준비하는 학생을 가장 깊이 이해하는 집단이 만든 새로운 도전입니다.',
    content: `안녕하세요.
SN독학기숙학원 대표 윤석기입니다.

2026년 2월 1일,
저희는 대치동에 **AI 특화 독학관리학원 '고요의 숲'**을 런칭했습니다.

---

## 반대와 우려

대치동에서 신규 브랜드를 시작하는 일은 결코 가볍지 않았습니다.
오히려 수많은 반대와 우려가 먼저 있었습니다.

> "지금 잘하고 있는 독학기숙학원이나 계속하지 왜 새로운 사업을 하느냐"
> "AI가 뜬다고 하니 남들 따라가는 것 아니냐"
> "대기업도 본격적으로 못 하는 AI를 중소 규모에서 한다는 게 맞느냐"
> "대치동은 완전히 다른 게임이다. 무모하다."

내부에서도, 외부에서도 비슷한 이야기들이 이어졌습니다.

솔직히 말하면,
**그 비판들 대부분은 틀리지 않았다고 생각합니다.**

독학기숙학원이라는 한 분야에서 전문성을 쌓아온 우리가
전혀 다른 무대인 대치동에서,
그것도 AI를 전면에 내세운 학원을 연다는 건
누군가에게는 당연히 불가능해 보였을 선택이었을 겁니다.
...
### 첫째, 우리는 수능을 준비하는 학생을 가장 깊이 이해하는 집단입니다

학생의 현재 위치, 심리 상태, 공부 전략, 흔들리는 지점까지.

**12년간 학생들과 함께해온 시간과 경험**이
이해를 가능하게 했습니다.
...
기존의 유능한 구성원들에 더해
이번 도전을 위해 새로운 인재들을 적극적으로 영입했습니다.

그들은 단순히 기술을 다루는 사람이 아니라,
**우리의 철학에 공감하며 교육을 다시 설계하기 위해 AI를 처음부터 다시 설계하고 개발하는 사람들**입니다.

---

### 셋째, 절박함이 있었습니다

무엇보다도 **바뀌지 않으면 곧 도태될 수 있다는 절박함**이 있었습니다.

지금은 잘 운영되고 있는 독학기숙학원일지라도
시장은 언제든 방향을 바꿀 수 있습니다.

우리는 살아남기 위해,
아니 정확히 말하면 **죽지 않기 위해 혁신을 선택**했습니다.

---

## 이 세 가지 이유로

우리는 대치동에 AI 특화 독학관리관을 열었습니다.

처음은 분명 서툴 수 있습니다.

그러나 **철학과 기술이 결합된 AI 교육**은
앞으로 반드시 필요해질 형태라고 확신합니다.

---

## 미래 교육의 방향

설령 우리가 이 도전에서 완벽한 성공을 거두지 못하더라도,
미래 교육은

- **AI 기반의 초개인화된 데이터 수집·분석·피드백**과
- **전문 인력의 밀착 관리**로 나아간다는 점에는

의심의 여지가 없다고 생각합니다.

그리고 그 길을
우리는 **개척자의 자세**로 먼저 걷고자 합니다.

---

## 결과로 증명하겠습니다

아직 시장에서 학생, 학부모, 그리고 교육 현장의 구성원들까지
AI 교육에 대한 이해도도 낮고 의구심도 많습니다.

그럼에도 불구하고
우리는 이 선택이 결국 옳았다는 것을
<mark style="background: linear-gradient(to top, rgba(255, 230, 0, 0.5) 50%, transparent 50%)">**결과로 증명해 보이겠습니다.**</mark>
...
하지만 요즘은, **수능이라는 이유로 AI를 전혀 쓰지 않는 선택**이 오히려 더 위험해지는 시대가 되었습니다.
...
이 지점에서 AI는 '공부를 대신해주는 존재'가 아니라, **생각을 도와주는 도구**로 작동하기 시작합니다.
...
즉, AI는 **같은 문제를 풀어도 '얻어가는 생각의 양'을 늘려주는 도구**입니다.

그래서 AI를 쓰는 학생은 문제를 더 많이 푸는 학생이 아니라, **같은 문제에서 더 많이 배우는 학생**이 됩니다.
...
## SNarGPT는 <mark style="background: linear-gradient(to top, rgba(255, 230, 0, 0.5) 50%, transparent 50%)">'기억하는 교육 AI'</mark>입니다
...
**학생의 사고 과정을 관리하는 조직**입니다.

그래서 우리에게 AI는 옵션도 아니고, 마케팅 수단도 아닙니다.

**반드시 중심에 있어야 하는 존재**였습니다.
...
**"AI를 쓸 것인가?"가 아니라 <mark style="background: linear-gradient(to top, rgba(255, 230, 0, 0.5) 50%, transparent 50%)">"AI를 어떻게 쓸 것인가?"</mark>**

우리는 공부를 대신해주는 AI가 아니라, **생각 과정을 끝까지 따라가는 AI**를 선택했습니다.
...
그래서 우리는 **교육 AI를 가장 잘 알고, 가장 잘 활용하는 에듀테크 기업**이라고 말할 수 있습니다.
`,
    category: 'columns',
    ...
    featuredOrder: 2,
    published: true,
    thumbnail: '/images/thumbnail/AI_STUDY_Blog.png',
...
`,
    ...
    featuredOrder: 1,
    published: true,
    thumbnail: '/images/thumbnail/study_timeline.png',
...
`,
    ...
    featuredOrder: 1,
    published: true,
    thumbnail: '/images/thumbnail/snargpt_quiz.png',
  ...
  },
  {
    ...
    content: `## ✅ 학생용 초요약 (TL;DR)

**이것만 기억하세요.**

1. **SNarGPT는 감시 도구가 아니라 공부 도우미입니다.**

2. AI를 반복적으로 괴롭히거나 딴짓에 쓰면 SNarKeeper가 자동으로 켜집니다.

3. 걸려도 대부분 **공부 열심히 + 사과**하면 풀립니다.

4. 마나는 함부로 쓰면 손해입니다. → **Gemini '균형' 모드가 가성비 최고**

5. AI를 존중하면 내 AI가 점점 더 똑똑해집니다.

> 위 5줄만 이해해도 이 공지는 끝입니다.
...
- **스터디 그룹**: 아직 개발 중 → 현재는 노출만 되고 기능은 비활성화

---

### 📌 공지 2. SNarGPT 모델 설정, 뭘로 해야 하나요?

결론부터 말하면 **"용도가 다릅니다."**

**Gemini (3 Flash 기준)**
- 감성적 / 인간적
- 유연하지만 → 실수·오류 빈도는 더 높음
...
### 📌 공지 3. 모의고사 PDF 생성 기능 관련

AI가 문법 하나라도 틀리면 결과물이 망가지는 구조라 난도가 높습니다.

현재 계속 개선 중이며, 오늘 개선을 했고 내일부터는 더 나아질 것입니다.

설령 잘못하더라도, 같은 실수를 반복하지 않도록 내부 맥락을 저장하도록 수정했습니다.

👉 **점점 좋아지는 구조입니다.**

---

### 📌 공지 4. SNarKeeper 생존 가이드

<details class="my-4 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
<summary class="cursor-pointer p-4 bg-stone-100 dark:bg-stone-800 hover:bg-stone-200 dark:hover:bg-stone-700 font-semibold text-gray-900 dark:text-white transition-colors">🛡️ SNarKeeper란 무엇인가요? (클릭해서 펼치기)</summary>
<div class="p-4 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300 leading-relaxed whitespace-pre-line">
<strong>SNarGPT의 든든한 문지기, SNarKeeper를 소개합니다!</strong>

<strong>1. SNarKeeper란 무엇인가요?</strong>
SNarKeeper는 SNarGPT 세계관의 <strong>'보안 및 학습 집중 관리 AI'</strong>입니다. 쉽게 말해, 여러분이 공부에만 전념할 수 있도록 입구에서 불필요한 질문이나 딴짓을 걸러주는 <strong>'무서운 형님들(Gatekeepers)'</strong>이라고 생각하면 됩니다.

즉, <strong>공부 질문만 받아주게 하는 AI</strong>입니다.

<strong>2. 왜 존재하나요? (존재 이유)</strong>
• <strong>마나(Mana) 보호</strong>: 공부와 상관없는 질문에 소중한 마나를 낭비하는 것을 막아줍니다.
• <strong>학습 몰입도 유지</strong>: 수능 성공이라는 목표에서 벗어나지 않도록 대화의 맥락을 학습 중심으로 고정합니다.
• <strong>시스템 안정성</strong>: 악의적인 공격이나 가스라이팅으로부터 SNARVIS와 친구들을 보호하여, 모든 학생이 쾌적하게 AI를 이용할 수 있게 합니다.
</div>
</details>

**🔴 SNarKeeper가 켜지는 경우**

- AI를 반복적으로 비꼬거나 괴롭히는 경우

- 공부와 무관한 딴짓을 지속적으로 시키는 경우

- 이전에도 비슷한 전적(?)이 있는 상태에서 다시 반복할 경우

> 대부분의 학생은 아예 발동될 일이 없습니다.

**🟢 SNarKeeper가 풀리는 방법**
- **실제로 공부하는 모습**을 보여주기
- **SNARVIS / SNarVIS 계열 AI**에게 잘못을 인정하고 사과하기

⚠️ **단,** 전적이 있는 학생의 경우 "풀어주는 척"만 할 수도 있습니다. 기록은 남기 때문에 사기치지 마세요.
...
**가장 가성비 좋은 설정**
👉 **Gemini '균형' 모드** (질문 1개당 보통 20~50 마나)
...
💡 **팁**: 이미지는 딱 필요한 부분만 잘라서 올리면 → **'눈알왕' 고성능 모드**가 안 켜집니다.

---

## 🌐 아래부터는: SNarGPT 세계관 & 상세 공지
...
SNarGPT의 대화 기록은 ❌ 구글, ❌ 외부 서버에 저장되지 않습니다.
...
하루 수천 건의 대화를 사람이 모니터링하는 것은 불가능하고, 그럴 이유도 없습니다.
그래서 **SNarKeeper & AI 고자질 기능**이 존재합니다.

### 학원 학생 전용 혜택

- 이 기능은 **학원 학생 전용** (일반 사용자는 절대 해당 없음)
- 대신 학원 학생들은:
...
- **SNARVIS**: 균형 · 친절 · 헌신
- **SNarGo**: 그런 거 없음
- **SNarGen**: 예측 불가, 잘못 건드리면 마나 폭발
- **SNarKeeper**: 그런 거 없음 (형님들임)
...
SNarGPT와 SNarLink 세계관은 ChatGPT나 Gemini의 성능과 한계를 충분히 알고 설계되었습니다.

- OpenAI 하이엔드 유저 경험
- Gemini Ultra 사용
- 매달 수십만 원 이상의 AI 실험 비용
- **SNarGo 정답률 99.9%** (5천 문제 검증)

이 검증 하나에:
- 3~4시간
- 100만 원 단위 비용
- 고난도 수학 로직을 사람이 직접 눈으로 검증

> 이 시스템은 "대충 만든 AI"가 아닙니다.

**결론은 단순합니다.**
앞으로 살아남으려면 **미친 듯이 공부하고, 집요하게 파고들어야 합니다.**
...
- **영상 링크 → 요약 가능** (오남용 ❌)
- 예전에 올린 파일/문서 → 맥락 주면 찾아줌
- **pdf / docx / xlsx / pptx 생성 가능** (hwp ❌ 설계자가 싫어함)
- "간지나게" 요청 가능 (100 마나 이하)
- AI가 처음에 잘 못하면 → 실수를 정확히 지적하고 → 비밀노트에 기록하도록 유도하면 → **점점 더 똑똑해집니다.**

---

## 🔮 앞으로의 업데이트

- **국어 RAG**: 공식 국어 문제 광속 접근 (1/14 기준 데이터 거의 완료)
- AI 노하우 적용
- **통합 Portal / SNOCR / AI-IoT 연동**

### 💡 팁
AI를 학대하면 실수율이 올라갑니다.
**공손하고 지적인 어투 = 더 똑똑한 AI**

---

## ✍️ 마무리

SNarGPT는 **각 학생마다 초개인화된 '동반자 AI'**입니다.
처음부터 그렇게 설계되었습니다.
...
`,
    ...
    featured: false,
    published: true,
    thumbnail: '/images/thumbnail/update_notice.png',
...
`,
  ...
  },
  {
    ...
    content: `## 이세돌의 질문, 그리고 AI 학습이 마주한 불편한 현실
...
<div class="my-8 aspect-video">
  <iframe
    src="https://www.youtube.com/embed/YdXUzOaFRA4"
    title="이세돌 강연"
    frameborder="0"
...
<details class="my-6 border border-stone-300 dark:border-stone-600 rounded-lg overflow-hidden">
<summary class="cursor-pointer p-4 bg-stone-100 dark:bg-stone-800 text-stone-700 dark:text-stone-200 font-medium">
영상 요약 보기
</summary>
<div class="p-6 bg-white dark:bg-stone-900 text-stone-600 dark:text-stone-300 text-sm leading-relaxed">

**2026 SW 산업전망 컨퍼런스 - 이세돌 특임교수 기조연설**
...
📌 **AI 시대에 인간이 나아가야 할 방향은?**
AI와의 대결 시대는 끝났으며, 인간은 콘텐츠를 만들고 방향성을 제시하며 끝맺음을 하는 역할을 하고, AI는 중간 과정에서 강력한 도구로 협력해야 합니다.

💡 **AI 활용 역량이 개인의 능력으로 평가되는 시대에 중요한 것은?**
창의적으로 질문하고, 주도적으로 판단하며, 이를 통해 커뮤니케이션하는 순환 과정을 지속하는 것이 중요합니다.
...
**바둑 인생의 시작과 철학**
이세돌 9단은 88년 만 4세에 바둑을 시작하여 19년 말 은퇴할 때까지 약 30년 이상 바둑을 두었다. 6세 때 아버지로부터 바둑을 취미가 아닌 전문가의 길로 걸을 것이라는 말씀을 들었다. 바둑을 마인드 스포츠나 보드 게임이 아닌, 둘이서 만들어 가는 하나의 작품 세계, 예술로 배웠다.

**프로 기사로서의 성장 과정**
9세에 서울로 올라와 선생님 문하에서 바둑을 배웠고, 만 12세에 프로에 입문했다. 프로 입문 후 프로의 벽을 느꼈으며, 첫 우승과 목표였던 이창호 사범을 이겼던 기억 등 30년 이상 굴곡이 있었지만 비교적 행복하고 의미 있는 시간이었다.

**2016년 알파고 대국: 큰 전환점**
2016년 알파고와의 대국은 이세돌 9단의 인생에서 큰 전환점이 되었다. 대국 제의를 받았을 당시, 이를 대결이 아닌 단순한 이벤트로 생각했으며, 자신이 질 것이라는 생각은 일도 하지 않았다. 다만, 언젠가는 체스처럼 바둑도 컴퓨터가 정복할 것이라 생각했고, 2016년이 그 시작을 끊는 사람이 되는 것이라 여겨 영광스럽게 생각했다.

**준비의 미흡함과 알파고의 개발자**
승부라고 생각하지 않았기 때문에 준비가 미흡했으며, 특히 AI에 대한 공부와 어떤 스타일로 둬야 할지에 대한 대비가 부족했다. 알파고를 만든 데미스 하사비스는 이후 알파폴드를 통해 단백질 구조를 밝혀내며 노벨상까지 받은 대단한 인물이다.
...
*대국 5개월 전 기보 분석의 한계*
대국 시점 5개월 전에 알파고의 기보를 봤을 때, 다른 프로 바둑 프로그램들과 차이점은 있었으나 자신과 대결하기에는 부족해 보였다. 5개월 후 알파고가 얼마나 실력이 올라올지 예측하는 것이 중요했으나, 과거 기보만 보고 마음을 놓았던 것은 프로 기사로서도, 대국 당사자로서도 아쉬운 부분이었다.

*미래를 내다보는 혜안의 중요성 (ChatGPT 사례)*
우리에게는 앞을 바라보는 혜안이 필요하다. ChatGPT의 경우, 2022년 11월 30일에 서비스를 시작했으나, 세상 밖으로 처음 선보인 것은 2019년 시범 자리였다. 당시 사람들은 ChatGPT를 '깡통'이라고 무시했으며, 기술이 발전했을 때 어떻게 될지 생각하지 못하고 "거짓말만 하는 깡통이네"라고 평가절하했다.

**2.2. 1국, 2국 패배와 바둑계의 충격**

*1국 패배: 심리적 요인과 생소함*
1국 전야제 때 구글 알파벳 회장이었던 에릭 슈미트 회장의 자신감 있는 발언을 듣고 이미 대국 전에 졌다고 느꼈으며, 경각심을 가지고 승리 예상 수위를 낮췄다 (5승 예상 → 3승 2패 예상). 바둑은 상대방의 기운이나 승부 호흡을 느끼며 두는데, 알파고는 모니터를 보고 바둑돌을 운반하는 사람(대리인)이 생각이나 의도가 없었기 때문에 기운을 느낄 수 없었다. 실제 대국에서 오는 생소함과 괴리감이 예상보다 너무 커서 실력을 발휘하지 못했고, 알파고의 강력함도 있었지만 스스로 무너진 패배였다. 1국 패배 후에는 "내 실력만 발휘하면 2, 3, 4, 5국은 다 이기지"라고 생각하며 크게 충격받지 않았다.

*2국 패배: 원인을 알 수 없는 패배*
2국이 끝나고 나서는 이세돌 9단뿐만 아니라 바둑계 전체의 시각과 관점이 완전히 달라졌다. 2국은 1국에서 느꼈던 생소함이 사라진 상태에서 최선을 다해 두었고 바둑 내용도 이상하지 않았으나, 속절없이 밀려 패배했다. 가장 충격적인 것은, 어디서 어떻게 실수를 해서 패배까지 이르게 됐는지 원인을 전혀 알 수 없었다는 점이다. 인간과의 대결에서는 복기를 통해 패배 원인을 알 수 있지만, 알파고와의 대국에서는 불가능했으며, 존경하는 선배 기사조차 "사람이 이길 수 없는 것 같으니 편안하게 두라"고 말할 정도로 바둑계 전체가 엄청난 충격을 받았다.

**2.3. 3국 패배와 인간의 무기력함**

*3국 작전의 실패*
3국에서는 알파고의 실력이 자신보다 우위에 있음을 인정하고 알파고에 맞춘 작전을 짜서 임했으나, 이는 굉장히 잘못된 작전이었다. 알파고의 엄청난 연산 능력을 감안하여 극초반에 승부를 거는 작전을 펼쳤다. 바둑은 돌 수가 적을수록 경우의 수가 많아지는데, 인공지능과 사람의 차이는 극초반에서 더욱더 크게 벌어진다. 그 이유는 사람은 돌 수가 적으면 수읽기를 할 수 없고 오직 감각에 의존해야 하는데, 결과는 데이터의 압승이었으며, 인간의 감각이 이렇게 무기력한 줄 처음 알았다.

*AI에 대한 무지와 자기 배제*
사람은 돌 수가 많아지면 수읽기를 할 수 있게 되므로, 수읽기와 감각이 공존하는 중반에서 AI와 승부를 했어야 했다. 이세돌 9단은 AI에 대해 너무 무지했고, AI만 생각하다 보니 사람인 자신을 제외하고 생각했던 부분도 있었다.
...
**3국 패배 후의 응원과 힘**
3국 패배 당일은 결혼 10주년 기념일이었으며, 구글 딥마인드 측에서 샴페인을 올려주기도 했다. 평소 대국 관련 기사나 댓글을 찾아보지 않지만, 이날은 온라인상에서 자신의 생존 여부를 확인차 찾아봤다. 악플이 아예 없진 않았지만 거의 대부분이 응원의 댓글이었으며, 가족, 동료, 지인들의 따뜻한 격려가 큰 힘이 되었다. 따뜻한 응원과 격려를 통해 힘을 얻는 것이 인간만의 능력이 아닌가 생각했다.

**4국 작전: 중반 승부와 버그 유도**
4국에서는 극초반은 안 되고, 돌 수가 너무 많아진 후반은 AI의 연산 능력 때문에 완벽하게 두어올 수 있으므로, 중반 50수에서 100수 사이를 노렸다. 중요한 것은 사람과의 대결처럼 정상적으로 이기는 것이 아니라, 알파고의 버그를 일으켜야 하는 것이었다.

**승부수 68수와 철학의 위배**
4국에서 알파고가 버그를 일으킨 것은 78수 이후이지만, 이 바둑의 진정한 승부수는 68번째 수였다. 68번째 수는 사람과의 대결이었다면 절대 두지 않을 수이며, 정수(최선의 수)가 아니었다. 이 수는 통하지 않았을 경우 당연히 패착이 될 수 있으며, "이세돌이 멘탈이 살짝 나갔다"고 평가받을 수도 있는 수였다. 이 수는 오직 알파고의 버그를 일으키려는 일념 하에 두어진 수였고, 결국 통하여 4국 승리로 이어졌다. 이 수는 이세돌 9단이 30년 바둑을 두면서 가진 신념과 철학에 정면으로 위배되는 수였으며, 정수가 아닌 것을 알면서 의도적으로 둔 것은 이것이 처음이자 마지막이었다. 이 한 판을 이기기 위해 신념과 철학을 위배하는 수를 두었어야 했는지에 대해 아직도 의문이 남는다.
...
*알파고 리 (AlphaGo Lee)*
이세돌 9단과의 대국을 통해 이세돌의 성을 따서 명칭이 붙었으며, 인간의 기보를 학습하고 딥러닝 강화 학습으로 만들어졌다.

*알파고 마스터 (AlphaGo Master)*
약 1년 후 출시되었으며, 인간의 기보를 학습한 것으로는 더 이상 올라갈 곳이 없다는 의미로 명칭이 붙었다. 알파고 리와 거의 같지만 더 많은 자체 대국과 디테일적인 기술이 추가되었으며, 이 버전이 나오면서부터 사람은 AI를 이기기가 사실상 어려워졌다. 알파고 마스터 버전이 나오면서 바둑 프로그램들이 쫙 깔려 누구나 쉽게 다운받을 수 있게 되었다. 이세돌 9단은 알파고 마스터 버전을 보며 "와 바둑 이렇게 두는 거구나"라며 감탄했다.

*알파고 제로 (AlphaGo Zero)*
약 6개월 후에 출시되었으며, 인간의 기보를 학습하지 않고 룰만 가르쳐 준 채 자체 대국만으로 학습했다. 이세돌 9단과 대국했던 알파고 리를 단 10일 만에 압도했으며, 알파고 마스터 버전도 약 40일 만에 압도하기 시작했다. 알파고 제로 버전이 나오면서 인간은 AI의 수를 이해하지 못하는 문제가 생겼다. 30년 바둑을 두었음에도 인공지능이 둔 수를 완전히 이해하지 못하는 현상은 상상할 수 없는 일이었으며, 이 버전이 나오면서 바둑은 완벽히 인간의 손을 떠났다고 생각해도 좋다.

**4.2. 바둑계의 대응과 해설의 변화**

*AI를 이해하려는 노력*
바둑이 인간의 손을 떠났다고 했지만, 프로 기사들은 지금도 바둑을 두고 있으며, 이는 인간의 바둑을 되찾아오려는 노력이다. AI를 이기기는 힘들겠지만, AI의 둔 수를 이해만 할 수 있다면 바둑이 인간의 손을 떠났다고 할 필요는 없다. 후배 기사들은 AI들을 이해하기 위해 노력하고 있으며, 다시 바둑을 인간의 손으로 돌려놓으려고 노력하고 있다.

*AI 전후의 해설 변화*
AI 이전(2015년)의 해설은 완벽하거나 정확하지 않았지만, 인간의 정을 느낄 수 있었다. 과거에는 프로 기사가 실수를 하고도 당당하게 쳐다보면 해설자들이 "저 수는 이세돌만이 둘 수 있는 수입니다"라고 평가하는 '맛'이 있었다. AI가 나오면서 해설은 AI를 보고 이루어지기 때문에, 수가 두어지면 퍼센티지가 떨어졌는지, 반집 손해인지 등이 정확하게 나오게 되었다. 이는 정확도가 올라갔다는 장점이 있지만, 개인적으로는 아쉬운 부분도 있다.

*AI 이후의 해설 방식*
AI 이후의 해설은 인공지능이 말하는 최선의 흐름을 해설자가 찾아내 전달하는 방식이다. 해설자들은 AI가 제시하는 수 중 아직 이해가 안 되는 부분은 더 물어보고 소개하겠다고 말하는 등, AI를 보고 해설한다. 해설자들은 AI를 보고 아마추어들이 편안하게 들을 수 있도록 전환하여 전달하는 역할을 한다고 볼 수 있다. AI는 바둑이 많이 기울었을 때 승률(예: 1.1%, 0.6%)을 보여주며, 한 수를 두었을 때 AI가 생각한 블루스팟에 두면 승률이 유지되고, 그렇지 않으면 승률이 떨어진다. 프로 기사들은 이 승률 변화를 보고 해설하고, 공부하고 있다.

**4.3. 바둑계 변화가 시사하는 산업 전반의 변화**

*AI 이전과 이후의 역할 변화*
AI 이전에는 바둑 프로 기사들이 바둑 기술 발전을 이끌었고, 아마추어들에게 영감을 주는 존재였다. 이제는 AI가 훨씬 더 높은 실력을 가지고 있으며, AI를 보고 공부하는 입장이 되었기 때문에, 인간이 바둑 기술 발전이나 큰 틀의 길을 제시하는 것은 사라졌다.

*AI 기반의 산업 적용*
이제 AI를 기반으로 바둑을 두어 가듯이, 이 일은 비단 바둑계만의 문제가 아니며, 모든 산업에서 동일하게 적용될 것이다.
...
*AI 바둑이 더 자연스럽고 창의적으로 느껴지는 충격*
이세돌 9단에게 알파고에게 패한 것보다 더 충격적이었던 것은, 왜 AI 바둑이 더 자연스럽고 창의적으로 느껴지냐는 부분이었다. 처음에는 바둑을 잘 두면 창의적으로 느껴지는가 생각했지만, 2017년 알파고 마스터 버전이 나오면서 어느 정도 이해하게 되었다.

*인간의 고정관념을 보여주는 사례*
알파고 마스터 버전은 세 번째 혹은 다섯 번째 수에 특정 자리를 두었는데, 이세돌 9단은 30분간 생각한 끝에 '괜찮은 수'라고 결론 내렸다. 한중일 수많은 기사와 기보 속에서 이 수를 찾지 못했는데, 이는 알파고 마스터 버전이 나오기 전까지 인간 프로 기사들은 이 수를 두지 못했다는 뜻이다. 이 수는 바둑을 배울 때 두지 말라고 배우는 수였기 때문에, 프로 기사가 되어서도 두지 못하는 인간의 고정관념을 보여주는 전형적인 사례이다. AI는 인간의 관점에서 봤을 때 사실상 고정관념이 없기 때문에 AI 바둑이 더 자연스럽고 창의적으로 느껴졌던 것이다. 고정관념이 없는 AI와 함께 협업하여 나아가야 하는 시대이다.

**5.2. AI 활용 역량에 따른 격차의 가속화**

*상향 평준화 예상의 빗나감*
이세돌 9단은 AI 바둑 프로그램이 깔리면서 정답을 보고 공부할 수 있게 되어 상향 평준화가 되고 절대적인 1인자는 나오기 힘들 것이라고 예상했다. 그러나 예상은 정반대로 갔으며, 이제 상위 랭커를 이기는 것이 하늘의 별따기가 될 정도로 어려워졌다.

*격차 발생의 원인*
탑 랭커들은 탑 랭커대로 쭉 나아갔는데, 그 이유는 상위 랭커가 하위 랭커보다 AI를 더 이해하고 더 잘 활용했기 때문이다.

*산업 전반의 격차 가속화*
이 현상은 바둑계만의 문제가 아니며, 생성형 AI가 나오면서 산업계 전반에 걸쳐 동일한 일이 벌어지고 있다. AI를 잘 이해하고 활용하는 사람들은 예전의 세네 명 이상의 몫을 하면서 앞서 나가고 있지만, 그렇지 못한 사람들은 자신의 자리마저 위협받는 것이 현실이다.

**5.3. AI 시대의 생존 순환 과정과 마인드셋**

*AI 활용 역량의 순환 과정*
AI 활용 역량이 곧 개인의 능력이 되는 시대이다. AI 시대의 생존 전략은 창의적으로 질문하고, 주도적으로 판단하며, 그것을 통해 커뮤니케이션하고, 다시 창의적 질문으로 돌아오는 순환 과정이다. 이 순환 과정을 루틴에서 계속 나아가는 것은 쉽지 않지만, 이 과정을 거친 사람과 거치지 않은 사람의 차이는 어마어마하게 벌어진다. 예전에는 격차가 점진적으로 벌어졌지만, 이제는 AI가 결과물들을 기하급수적으로 쏟아내면서 격차가 가속화되고 있다.

*AI와의 관계 설정 (협력 도구)*
AI와의 대결 시대는 이미 끝났으며, 이제는 AI와 대결하는 시대가 아니다. 인간은 처음의 방향성을 제시하고 끝맺음을 하는 역할을 하며, 그 중간 부분에서 AI가 큰 도움을 줄 수 있다. 룰이 명확하고 한정적인 상황에서는 AI가 엄청나게 강력한 힘을 내며, 프로젝트나 일은 어느 정도 룰이 생기고 한정적이 되므로 AI가 강력할 수밖에 없다. 이제 AI는 도구로 바라보든 친구로 바라보든 같이 나가는 존재가 되었으며, AI를 활용하여 협력해야 하는 존재이다.

**5.4. 궁극적인 목표: 콘텐츠를 만드는 사람**

*AI 시대에 해야 할 일*
AI 시대에 무엇을 해야 하느냐는 질문에 정답은 없지만, 궁극적으로 콘텐츠를 만드는 사람이 되어야 한다.

*콘텐츠 제작의 역할 분담*
AI가 소설, 영상 등 많은 콘텐츠 부분들을 해 줄 것이며, 대부분의 콘텐츠를 AI가 만든 것을 보게 될 확률이 높다. 하지만 AI가 처음부터 모든 것을 하는 것이 아니라, 인간이 어느 정도 방향성을 정해주고 끝맺음을 해 줬을 것이다. 콘텐츠를 만들고 끝맺음을 할 수 있는 사람이 앞으로 더 나아갈 수 있다.
...
<div class="grid md:grid-cols-2 gap-6 my-8">
  <div class="bg-stone-100 dark:bg-stone-800 border border-stone-300 dark:border-stone-600 rounded-lg p-6">
    <h3 class="text-lg font-bold text-stone-700 dark:text-stone-200 mb-3">하위 랭커</h3>
    <p class="text-stone-600 dark:text-stone-300">
      AI가 제시하는 수를 그대로 따라가는 데 집중
    </p>
  </div>
  <div class="bg-stone-100 dark:bg-stone-800 border border-stone-300 dark:border-stone-600 rounded-lg p-6">
    <h3 class="text-lg font-bold text-stone-700 dark:text-stone-200 mb-3">상위 랭커</h3>
    <p class="text-stone-600 dark:text-stone-300">
...
<div class="bg-stone-100 dark:bg-stone-800 border-l-4 border-stone-400 p-6 my-8 rounded-r-lg">
...
`,
    ...
    featuredOrder: 1,
    published: true,
    thumbnail: '/images/thumbnail/thumbnail_alphago.png',
...
<div class="mt-8 rounded-2xl bg-gray-50 dark:bg-gray-800 p-6 text-sm text-gray-600 dark:text-gray-300 border border-gray-100 dark:border-gray-700">
  ...
  },
  {
    ...
    featured: false,
    published: true,
    thumbnail: '/images/thumbnail/thumbnail_a1.png',
