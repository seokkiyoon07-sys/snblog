...
export const allPosts: Post[] = [
  {
    id: '2028-integrated-science-study-guide',
    title: '2028 수능 통합과학, 25개 예시문항에서 공부의 방향을 찾다',
    excerpt:
      '통합과학 예시문항 25개의 풀이와 역분해를 바탕으로 개념 구분, 자료 해석, 탐구 설계, 정량 추론의 학습 방향을 정리합니다. 유사 기출에서 무엇을 연습해야 하는지도 함께 살펴봅니다.',
    category: 'integrated-science-problem',
    tags: [
      '2028 수능',
      '통합과학',
      '예시문항 분석',
    ...
    published: true,
    thumbnail:
      '/images/thumbnail/problem-download/2028-integrated-science-study-guide.svg',
    url: '/problem-download/2028-integrated-science-study-guide',
    badge: '25문항 학습 가이드',
  },
  {
    id: '2028-integrated-science-examples',
    title: '2028 수능 통합과학 예시문항 25제 분석',
    excerpt:
      '통합과학 예시문항 1~25번 원문과 정답·배점을 확인하세요. 1~25번 풀이·문항 역분해와 연계 기출 자료 72개(원본 확인 필요 1개 포함)를 제공합니다. SNargen 생성 변형문제는 준비 중입니다.',
    category: 'integrated-science-problem',
    tags: ['2028 수능', '통합과학', '예시문항', '문항 분석'],
    author: 'SN Academy',
    date: '2026-09-13',
    readTime: '1',
    featured: false,
    published: true,
    thumbnail: '/images/thumbnail/problem-download/2028-integrated-science.svg',
    url: '/problem-download/2028-integrated-science-examples',
    badge: '25문항 원문 · 1~25번 분석 공개',
  },
  {
  ...
  },
  {
    ...
    featured: false,
    published: true,
    thumbnail: '/images/thumbnail/originals/70_temporaryport.png',
    youtubeUrl: 'https://www.youtube.com/embed/NR3l3IcSzJo',
    url: '/originals/gihangji-1',
  ...
  },
  {
    id: 'dukkeopjeon',
    title:
      '정직하면 지는 게임, 조선 우화가 그린 최악의 회식 자리 | EBS 2027 수능완성 문학 고전소설 「두껍전」',
    excerpt:
    ...
    featured: false,
    published: true,
    thumbnail: '/images/thumbnail/originals/69_frog.png',
    youtubeUrl: 'https://www.youtube.com/embed/J_M_hphCyIA?start=3',
    url: '/originals/dukkeopjeon',
    layoutVariant: 'original-only',
    type: 'special',
  },
  {
    id: 'muo-sahwa-1',
    title: '무오사화 1화 | 죽은 뒤 무덤에서 끌려나와 목이 잘린 관료, 조위',
    excerpt:
      'SN History 무오사화 시리즈 1화. 죽은 뒤 무덤에서 끌려나와 목이 잘린 관료, 조위.',
    category: 'SN History',
    tags: ['SN History', '무오사화', '조선시대', '역사숏츠'],
    author: 'SN History',
    date: '2026-09-10',
    readTime: '숏츠',
    featured: false,
    ...
    seriesOrder: 1,
    badge: '무오사화 1화',
    thumbnail: '/images/thumbnail/history/muo-sahwa-1.jpg',
    youtubeUrl: 'https://www.youtube.com/shorts/_8SzklBj-XI',
    url: '/history/muo-sahwa-1',
  },
  {
    id: 'muo-sahwa-2',
    title: '무오사화 2화 | 임금도 볼 수 없던 사초에서 ‘반역문’이 나왔다',
    excerpt:
      'SN History 무오사화 시리즈 2화. 임금도 볼 수 없던 사초에서 ‘반역문’이 나왔다.',
    category: 'SN History',
    tags: ['SN History', '무오사화', '조선시대', '역사숏츠'],
    author: 'SN History',
    date: '2026-09-10',
    ...
    seriesOrder: 2,
    badge: '무오사화 2화',
    thumbnail: '/images/thumbnail/history/muo-sahwa-2.jpg',
    youtubeUrl: 'https://www.youtube.com/shorts/J7u6jAEmc0w',
    url: '/history/muo-sahwa-2',
  },
  {
    id: 'muo-sahwa-3',
    title: '무오사화 3화 | 사적인 원한에서 사림의 참극으로',
    excerpt: 'SN History 무오사화 시리즈 3화. 사적인 원한에서 사림의 참극으로.',
    category: 'SN History',
    tags: ['SN History', '무오사화', '조선시대', '역사숏츠'],
    author: 'SN History',
    date: '2026-09-10',
    ...
    seriesOrder: 3,
    badge: '무오사화 3화',
    thumbnail: '/images/thumbnail/history/muo-sahwa-3.jpg',
    youtubeUrl: 'https://www.youtube.com/shorts/7JuYgGZbPpQ',
    url: '/history/muo-sahwa-3',
  },
  {
    id: 'muo-sahwa-4',
    title: '무오사화 4화 | 명나라에 갔다 돌아오니 대역죄인이 되어 있었다 (完)',
    excerpt:
      'SN History 무오사화 시리즈 마지막 이야기. 명나라에 갔다 돌아오니 대역죄인이 되어 있었다.',
    category: 'SN History',
    tags: ['SN History', '무오사화', '조선시대', '역사숏츠'],
    author: 'SN History',
    date: '2026-09-10',
    ...
    seriesOrder: 4,
    badge: '무오사화 4화 · 완결',
    thumbnail: '/images/thumbnail/history/muo-sahwa-4.jpg',
    youtubeUrl: 'https://www.youtube.com/shorts/3XjSVW-Yxfs',
    url: '/history/muo-sahwa-4',
  },
  {
    ...
    featuredOrder: 4,
    published: true,
    thumbnail: '/images/thumbnail/problem-download/20260902_math_thumbnail.png',
