  ...
  try {
    ...
    switch (type) {
      case 'post':
        ...
        revalidatedPaths = [`/${category}/${postId}`, `/posts/${postId}`, '/', `/${category}`]
        revalidatedTags = ['posts', `post:${postId}`, `category:${category}`, 'homepage']
        break
      ...
      default:
        ...
        revalidatedTags = ['posts', 'homepage', 'columns', 'startup', 'originals']
    }
