...
export default async function DataLabPostPage({ params }: PostPageProps) {
  ...
  if (post.type === 'special' && isSchoolPriceMap) {
    ...
    const dateModified = isWinterSchoolMap ? '2026-09-10' : '2026-01-30';
...
## 데이터 상태
- 기존 공식 자료와 2026년 9월 10일 제공된 추가 조사 자료를 반영하고, 확인된 가격과 공개 대기 상태를 구분합니다.
- 자료가 상충하는 금액은 재확인 필요 상태로 표시합니다.
- 목록과 지도는 대표 과정의 실제 기간과 총액을 먼저 표시합니다. 목록의 5주 환산가는 보조 비교 정보입니다. 월 비용만 확인된 과정과 별도 스프링캠프는 5주 환산 비교에서 제외합니다.
