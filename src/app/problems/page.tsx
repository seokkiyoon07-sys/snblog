export const metadata = {
  ...
  description: 'SN Academy에서 제공하는 수학 문제집과 기출문제를 다운로드하세요. 수능, 모의고사, 기출문제 등 다양한 수학 문제를 무료로 제공합니다.',
  keywords: '문제 다운로드, 수학 문제집, 수능 기출, 모의고사, 수학 문제, SN Academy',
  openGraph: {
    title: '문제 다운로드 | SN Academy 수학 문제집',
    description: 'SN Academy에서 제공하는 수학 문제집과 기출문제를 다운로드하세요.',
    type: 'website',
    locale: 'ko_KR',
  },
};
