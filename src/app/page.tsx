  ...
  const posts = [
    {
      ...
      excerpt: '2024년 수능의 주요 변화점을 분석하고 효과적인 대비 전략을 제시합니다. 특히 국어 영역의 독서 지문 길이 증가와 수학 영역의 문제 유형 변화에 대해 자세히 다룹니다. 시대인재에서 3년간 축적된 데이터를 바탕으로 한 실질적인 조언을 제공합니다.',
      date: 'Dec 15, 2024',
      readTime: '8 min read',
      tags: ['입시정보', '수능', '분석'],
    ...
    {
      id: 2,
      title: '시대인재 학습법: 효과적인 자기주도학습 방법',
      excerpt: '시대인재에서 검증된 자기주도학습 방법을 소개합니다. 계획 세우기부터 실행, 피드백까지의 전체 과정을 단계별로 설명하고, 실제 학생들의 성공 사례를 통해 구체적인 적용 방법을 제시합니다. 특히 고3 수험생들에게 도움이 되는 실용적인 내용을 담았습니다.',
      date: 'Dec 12, 2024',
      readTime: '6 min read',
      tags: ['컬럼', '학습법', '자기주도학습'],
    ...
    },
    {
      ...
      excerpt: '서울대에 합격한 김○○ 학생의 시대인재 3년 생활 후기를 공유합니다. 입학부터 졸업까지의 과정에서 겪었던 어려움과 극복 방법, 그리고 시대인재에서 얻은 것들에 대해 솔직하게 이야기합니다. 후배들에게 전하는 조언도 함께 들어보세요.',
      date: 'Dec 10, 2024',
    ...
    },
    {
      ...
      excerpt: '2024년 겨울방학을 맞아 시대인재에서 진행하는 특별 프로그램을 소개합니다. 수능 대비 집중 캠프, 논술 특강, 면접 준비반 등 다양한 프로그램이 준비되어 있습니다. 각 프로그램의 특징과 참가 방법, 그리고 기대 효과에 대해 자세히 알아보세요.',
      date: 'Dec 8, 2024',
      readTime: '5 min read',
    ...
    },
    {
      ...
      excerpt: '시대인재의 자랑스러운 교사진을 소개합니다. 각 분야의 전문가들이 모여 학생들의 꿈을 실현시키기 위해 최선을 다하고 있습니다. 교사들의 경력과 교육 철학, 그리고 학생들과의 특별한 에피소드를 통해 시대인재만의 교육 문화를 엿볼 수 있습니다.',
      date: 'Dec 3, 2024',
      readTime: '7 min read',
