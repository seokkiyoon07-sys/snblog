...
export const metadata = {
  title: '갑민가 | SN Originals 고전문학',
  description: 'AI 그림과 친절한 해설로 즐기는 고전문학! 보기만 해도 국어 감각이 살아납니다. 수능 대비는 물론, 고전문학을 친숙하게 이해하고 싶다면 지금 바로 시작하세요!',
  keywords: '갑민가, 고전문학, 수능국어, SN Originals, AI 그림, 해설',
  openGraph: {
    title: '갑민가 | SN Originals 고전문학',
    description: 'AI 그림과 친절한 해설로 즐기는 고전문학! 보기만 해도 국어 감각이 살아납니다.',
    type: 'video.other',
    locale: 'ko_KR',
  },
};

export default function GapmingaPage() {
  const post = {
    id: 5,
