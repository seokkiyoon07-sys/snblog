...
export const metadata: Metadata = {
  ...
  description: '알면 사랑한다는 최재천 선생님의 지혜로 시작하는 SN Originals 고전문학 시리즈. AI 기술과 함께하는 새로운 고전문학 학습법을 만나보세요.',
  alternates: { 
  ...
  twitter: {
    ...
    title: 'SN Originals 고전문학 시리즈를 소개합니다',
    description: '알면 사랑한다는 최재천 선생님의 지혜로 시작하는 SN Originals 고전문학 시리즈.',
    images: ['/image/originalintro1.png'],
  },
  robots: { 
    index: true, 
    follow: true 
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <Callout variant="info" title="핵심 철학">
                  <p className="font-semibold text-lg mb-2">
                    "우리가 좋아해서 흥미롭게 보았던 콘텐츠는 기억하려 하지 않아도 기억이 날 수밖에 없다"
                  </p>
            ...
            <Section title="📅 업로드 계획">
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  현재의 계획은 <strong>주2회(화/금) 베이스</strong>로 고전문학 시리즈를 업로드하여 비단 금번 2026 수능만을 
            ...
            <Section title="🎥 YouTube 채널 계획">
              <p className="text-gray-700 leading-relaxed">
                ...
                기준으로는 롱폼 형태의 동영상만 올라가고 있지만, 조만간 숏폼과 모든 영상에 한/영 자막이 추가될 예정입니다. 
          ...
          <div className="border-t border-slate-200 pt-6 mt-8">
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-slate-100 text-slate-600 text-sm rounded-full">고전문학</span>
              <span className="px-3 py-1 bg-slate-100 text-slate-600 text-sm rounded-full">SN Originals</span>
              <span className="px-3 py-1 bg-slate-100 text-slate-600 text-sm rounded-full">교육혁신</span>
              <span className="px-3 py-1 bg-slate-100 text-slate-600 text-sm rounded-full">AI교육</span>
            </div>
          </div>
        </div>
      </article>
