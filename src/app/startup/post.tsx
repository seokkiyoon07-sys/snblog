    ...
    <main className="mx-auto max-w-5xl px-4 py-10 lg:py-16">
      ...
      <section id="why" className="mt-16 space-y-8">
        ...
        <p className="text-muted-foreground leading-relaxed">
          ...
          <strong>수능 전용 AI</strong>로, 범용 LLM보다 수능 맥락을 깊게
          이해합니다.
        </p>
        ...
        <div className="border rounded-2xl p-6 md:p-10 grid md:grid-cols-2 gap-6 items-center">
          <div className="space-y-4">
            <h3 className="text-xl md:text-2xl font-semibold flex items-center gap-2">
              <BookOpenText className="size-5" /> SNarVIS 해설 루프
            </h3>
      ...
      <section className="mt-16">
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="q3">
            ...
            <AccordionContent>
              사람에게 직관적으로 쉬운데 AI에게 논리적 함정이 있는 유형을 간혹
              틀릴 수 있습니다. 그러나 이러한 사례는 다음 버전의 개선 데이터로
              활용됩니다.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      ...
      <footer className="mt-20 text-center text-sm text-muted-foreground">
        <p>
          ...
          성장시키는 것 — 그것이 SN의 Vertical AI가 교육을 바꾸는 방식입니다.
        </p>
      </footer>
    </main>
  );
