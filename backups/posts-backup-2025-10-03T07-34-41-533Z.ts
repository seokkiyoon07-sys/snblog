  ...
  <div className="mx-auto max-w-5xl">
    ...
    <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md">
        <h3 className="font-semibold">대표 (CEO)</h3>
        <p className="mt-2 text-sm text-slate-600">교육 현장 20년 경험, 전략과 비전을 이끄는 리더</p>
      </div>
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md">
        <h3 className="font-semibold">AI 개발자 2명</h3>
        <p className="mt-2 text-sm text-slate-600">대규모 언어모델과 AI 솔루션 연구</p>
      </div>
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md">
        <h3 className="font-semibold">백엔드 개발자 1명</h3>
        <p className="mt-2 text-sm text-slate-600">안정적인 데이터 처리와 서버 아키텍처</p>
      </div>
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md">
        <h3 className="font-semibold">마케팅/데이터 분석 1명</h3>
        <p className="mt-2 text-sm text-slate-600">학습 데이터 기반 전략 수립</p>
      </div>
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md">
        <h3 className="font-semibold">디자이너 1명</h3>
        <p className="mt-2 text-sm text-slate-600">직관적이고 감각적인 UX/UI 구현</p>
      </div>
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md">
        <h3 className="font-semibold">프론트엔드 개발자 1명</h3>
        <p className="mt-2 text-sm text-slate-600">웹/앱 인터페이스 개발</p>
      </div>
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md">
        <h3 className="font-semibold">라벨링 전문가 1명</h3>
        <p className="mt-2 text-sm text-slate-600">AI 학습 데이터셋 구축 및 정제</p>
      </div>
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md">
        <h3 className="font-semibold">운영 인력 1명</h3>
        <p className="mt-2 text-sm text-slate-600">현장 운영 및 사용자 피드백</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div className="mt-6 grid gap-4 md:grid-cols-2">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold">SNarlink</h3>
          <span className="rounded-full border border-slate-200 px-3 py-1 text-xs">AI</span>
        </div>
        <p className="mt-2 text-sm text-slate-600">초정밀 학습 분석 방화벽 시스템</p>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold">SNarGPT</h3>
          <span className="rounded-full border border-slate-200 px-3 py-1 text-xs">AI</span>
        </div>
        <p className="mt-2 text-sm text-slate-600">수능 수학 문제를 99%+ 정확도로 풀이</p>
        <ul className="mt-4 space-y-1 list-disc pl-5 text-sm text-slate-700">
          <li>정확한 개념 설명과 단계별 풀이</li>
          <li>실제 수험생에게 필요한 피드백 제공</li>
        </ul>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold">SNarGO</h3>
          <span className="rounded-full border border-slate-200 px-3 py-1 text-xs">AI</span>
        </div>
        <p className="mt-2 text-sm text-slate-600">수능문제 풀이 전문 AI</p>
        <ul className="mt-4 space-y-1 list-disc pl-5 text-sm text-slate-700">
          <li>평가원 기출부터 최신 모의고사까지 정밀 해설</li>
          <li>원하는 방식으로 빠르고 정확한 풀이</li>
        </ul>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold">SNarGEN</h3>
          <span className="rounded-full border border-slate-200 px-3 py-1 text-xs">AI</span>
        </div>
        <p className="mt-2 text-sm text-slate-600">기존 교육 업체의 1% 비용으로 고퀄 문제 생성</p>
        <ul className="mt-4 space-y-1 list-disc pl-5 text-sm text-slate-700">
          <li>평가원 수준의 문항 자동 생성</li>
          <li>콘텐츠 제작의 패러다임 전환</li>
        </ul>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold">SNarOCR</h3>
          <span className="rounded-full border border-slate-200 px-3 py-1 text-xs">AI</span>
        </div>
        <p className="mt-2 text-sm text-slate-600">촬영만 하면 자동 인식·분석하는 시험지 OCR</p>
        <ul className="mt-4 space-y-1 list-disc pl-5 text-sm text-slate-700">
          <li>문제 영역 자동 인식 및 정규화</li>
          <li>문제은행 연동으로 즉시 학습 관리</li>
        </ul>
      </div>
    </div>
  </div>
